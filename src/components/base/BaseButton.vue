<template>
  <Component
    :is="as"
    class="inline-flex flex-none items-center justify-center whitespace-nowrap rounded-md font-medium transition-colors focus:outline-none focus:ring disabled:pointer-events-none"
