  ...
  <form class="p-4" @submit.prevent="onSubmit">
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        <h2 class="text-base font-semibold leading-7 text-gray-900">New Study</h2>
        ...
        <div class="mt-2">
          ...
          <!-- <div class="col-span-full">
            <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Chapters</label>
            <BaseFileUpload :multiple="true" accept=".pgn" />
          </div> -->
        </div>
      </div>
      <!-- <div class="border-b border-gray-900/10 pb-12">
